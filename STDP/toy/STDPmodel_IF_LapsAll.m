...
% Synapses params
Imax = 125e-12 %85e-12; % max synaptic weight, a current in Amps. % NolanWiles2011 uses 10-226pA. Mehta uses 1.5-4nA. SongAbbot use dimensionless conductances with G between 0 and Gmax, but not sure about the initial weight matrix. 
Idecay = 10e-3; % EPSC time constant, in sec
Wsd = 10; % in neurons. Standard deviation of initial synaptic weight vector (for gaussian connectivity)
...
Pamp = 0%0.005*Imax; % peak Pre-before-Post weight change (0.5% in SongAbbot2000, 0.6pA with no Imax in MehtaWilson2000)
Damp = 0%-0.005*Imax; % peak Post-before-Pre weight change (0.525% in SongAbbott2000, 90% of Pamp in MehtaWilson2000, which didn't have a maximum weight)
